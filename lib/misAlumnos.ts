...
// level_test_provisional* llegan con supabase-level-test-v2.sql, y
// teacher_confirmed_* con supabase-teacher-level.sql y teacher_confirmed_against
// con supabase-teacher-level-against.sql. Van AQUÍ, en el
...
const PROFILE_COLS_EXTRA = `${PROFILE_COLS}, active_intervention, active_intervention_at, unattended_alerts, level_test_provisional, level_test_provisional_reason, teacher_confirmed_level, teacher_confirmed_at, teacher_confirmed_by, teacher_confirmed_against`;
