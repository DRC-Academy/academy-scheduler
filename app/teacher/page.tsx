...
// ─── Mis clases (Finanzas del profesor) ───────────────────────────────────────
...
function TeacherContent() {
  ...
  const [activeTab, setActiveTab] = useState<'calendar' | 'upcoming' | 'students' | 'myclasses' | 'scoring' | 'notifications'>('calendar');
