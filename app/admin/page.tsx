...
// La auditoría de vínculos y las sincronizaciones se fueron con el Resumen a
// components/admin/DashboardGeneral: sus `db*` ya no se importan acá.
...
/**
 * La pestaña "Resumen" ('overview') dejó de vivir acá en septiembre de 2026: es
 * la página /dashboard. Los enlaces viejos siguen funcionando, se redirigen.
 */
...
function AdminContent() {
  ...
  // recargar o al cambiar de pestaña.
